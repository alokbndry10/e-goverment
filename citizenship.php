...
// Get Citizenship document
$stmt = $pdo->prepare("SELECT * FROM documents WHERE user_id = ? AND document_type = 'citizenship' ORDER BY submitted_at DESC LIMIT 1");
$stmt->execute([$_SESSION['user_id']]);
$citizenshipDoc = $stmt->fetch();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Citizenship - Nagarik App</title>
...
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <h2 class="section-title">CITIZENSHIP (नागरिकता)</h2>
            
            <?php if ($citizenshipDoc && $citizenshipDoc['status'] === 'verified'): ?>
                ...
                <div class="upload-container">
                    <div class="document-view">
                        ...
                        <p style="color: #666; margin: 10px 0;">Citizenship Number: <?php echo sanitize($citizenshipDoc['document_number']); ?></p>
                        <div class="document-images">
                            <div class="document-image-card">
                                <img src="<?php echo sanitize($citizenshipDoc['front_image']); ?>" alt="Citizenship Front">
                                <p>Front Side</p>
                            </div>
                            <?php if ($citizenshipDoc['back_image']): ?>
                            <div class="document-image-card">
                                <img src="<?php echo sanitize($citizenshipDoc['back_image']); ?>" alt="Citizenship Back">
                                <p>Back Side</p>
                            </div>
                            <?php endif; ?>
                        </div>
            ...
            <?php elseif ($citizenshipDoc && $citizenshipDoc['status'] === 'pending'): ?>
                <!-- Show pending status -->
                <div class="upload-container">
                    <div class="document-view">
                        ...
                        <p style="color: #666; margin: 10px 0;">Citizenship Number: <?php echo sanitize($citizenshipDoc['document_number']); ?></p>
                        <p style="color: #666;">Submitted on: <?php echo date('F j, Y', strtotime($citizenshipDoc['submitted_at'])); ?></p>
                        <div class="document-images">
                            <div class="document-image-card">
                                <img src="<?php echo sanitize($citizenshipDoc['front_image']); ?>" alt="Citizenship Front">
                                <p>Front Side</p>
            ...
            <?php elseif ($citizenshipDoc && $citizenshipDoc['status'] === 'rejected'): ?>
                <!-- Show rejected status and allow resubmission -->
                <div class="upload-container">
                    <div class="alert alert-error">
                        <strong>Your previous submission was rejected.</strong><br>
                        <?php if ($citizenshipDoc['remarks']): ?>
                            Reason: <?php echo sanitize($citizenshipDoc['remarks']); ?>
                        <?php endif; ?>
                    </div>
                    
                    <h3 style="color: #1e3c72; margin-bottom: 20px;">Submit New Citizenship Document</h3>
                    ...
                    <form action="auth/upload_document.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="upload-section">
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" name="document_number" placeholder="Enter your Citizenship number" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="upload-section">
                            <h3>Back Side of Citizenship (Optional)</h3>
